...
// @Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-01-03T16:16:33.363267-08:00[America/Los_Angeles]", comments = "Generator version: 7.5.0")
    ...
    protected static final Logger	logger	= LoggerFactory
        .getLogger(ApplicationApiController.class);


        private final ApplicationApiDelegate delegate;

        public ApplicationApiController(@Autowired(required = false) ApplicationApiDelegate delegate) {
        this.delegate = Optional.ofNullable(delegate).orElse(new ApplicationApiDelegate() {});
        }
