...
import com.valkyrlabs.model.ContentDataService;
...
/**
* A delegate to be called by the {@link ContentDataApiController}}.
* Implement this interface with a {@link org.springframework.stereotype.Service} annotated class.
*/
@Controller
// @Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-01-03T16:22:46.987665-08:00[America/Los_Angeles]", comments = "Generator version: 7.5.0")
public class ContentDataApiDelegate {

    protected static final Logger	logger	= LoggerFactory.getLogger(ContentDataApiDelegate.class);
    ...
    public Optional<NativeWebRequest> getRequest() {
        ...
        * @see ContentDataApi#deleteContentData
        */
    ...
    public CompletableFuture<ResponseEntity<Void>> deleteContentData(UUID id) {
        // ThorAPI Method Template

        
        // ThorAPI DELETE
        if(contentDataService.findById(id).isEmpty()){
            return CompletableFuture.completedFuture(new ResponseEntity<>(HttpStatus.NOT_FOUND));
        }
        logger.info("DELETING: {}:{} " , "ContentDataApi",  id);

            contentDataService.deleteById(id);
        ...
        * @return Successfully retrieved the ContentData. (status code 200)
            *         or ContentData not found. (status code 404)
            *         or Internal server error. (status code 500)
        * @see ContentDataApi#getContentData
        */
    ...
    public CompletableFuture<ResponseEntity<ContentData>> getContentData(UUID id) {
        // ThorAPI Method Template
            ...
            getRequest().ifPresent(request -> {
                ...
                /// ThorAPI method impl
                            // ThorAPI GET
                            logger.info("GETTING: {}:{} " , "ContentDataApi",  id);
                            Optional<ContentData> ox = contentDataService.findById(id);
                            if(ox.isEmpty()){
                                return new ResponseEntity<>( HttpStatus.NOT_FOUND);
                            }
                            return new ResponseEntity<ContentData>(ox.get(), HttpStatus.OK);
        ...
        * @return Successfully retrieved the list of ContentDatas. (status code 200)
            ...
            *         or Internal server error. (status code 500)
        * @see ContentDataApi#getContentDataList
        */

    // THORApi Permissions
    // ThorAPI LIST
    // @PostFilter("hasPermission(filterObject, 'READ')")
    public CompletableFuture<ResponseEntity<List<ContentData>>> getContentDataList() {
        // ThorAPI Method Template
            ...
            getRequest().ifPresent(request -> {
                            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                            if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                                String exampleString = "[ { \"largeImage\" : \"https://valkyrlabs.com/assets/VALKYR_LABS_INC_LOGO-BKV9JIdt.png\", \"contentData\" : \"The full content\", \"releaseDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedById\" : \"9dda17f7-3dad-4e27-af12-c2fc49cf31e1\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"title\" : \"Amazing Things Happened\", \"ownerId\" : \"bbf5fafc-2e00-4167-ad99-3abce968f129\", \"principal\" : { \"residenceCountry\" : \"USA\", \"residenceState\" : \"CA\", \"lastName\" : \"Harmony\", \"addresses\" : [ { \"country\" : \"USA\", \"hasWifi\" : true, \"city\" : \"San Francisco\", \"lastAccessedById\" : \"ef297a29-e742-4535-82c6-6ef6211bca12\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"addressType\" : \"home\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"ownerId\" : \"5297b19d-fd2a-4007-9aef-f0b7264cd539\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"ba749007-a05a-4505-a434-d92c7cf9712d\", \"name\" : \"Henry Johnson\", \"street1\" : \"123 Daydream Blvd.\", \"street2\" : \"Apt. 7\", \"state\" : \"CA\", \"id\" : \"3773d666-dea1-4d02-b430-11ca52e266a8\", \"postal_code\" : \"94210-0000\" }, { \"country\" : \"USA\", \"hasWifi\" : true, \"city\" : \"San Francisco\", \"lastAccessedById\" : \"ef297a29-e742-4535-82c6-6ef6211bca12\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"addressType\" : \"home\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"ownerId\" : \"5297b19d-fd2a-4007-9aef-f0b7264cd539\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"ba749007-a05a-4505-a434-d92c7cf9712d\", \"name\" : \"Henry Johnson\", \"street1\" : \"123 Daydream Blvd.\", \"street2\" : \"Apt. 7\", \"state\" : \"CA\", \"id\" : \"3773d666-dea1-4d02-b430-11ca52e266a8\", \"postal_code\" : \"94210-0000\" } ], \"notes\" : \"Notes about this account\", \"lastAccessedById\" : \"1417708a-45ad-43cd-a294-521766640255\", \"acceptedCookies\" : false, \"roles\" : [ { \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedById\" : \"e9b571b9-7603-4eba-822e-aa0005aff37a\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"cd99207c-073f-46f6-94f1-a9419d67befa\", \"roleName\" : \"ANONYMOUS\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"id\" : \"5b7c95bb-95c1-4cf9-86ca-c7d5f1d0a3b8\", \"ownerId\" : \"77d060ed-e686-4102-8a69-937a7e385efb\" }, { \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedById\" : \"e9b571b9-7603-4eba-822e-aa0005aff37a\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"cd99207c-073f-46f6-94f1-a9419d67befa\", \"roleName\" : \"ANONYMOUS\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"id\" : \"5b7c95bb-95c1-4cf9-86ca-c7d5f1d0a3b8\", \"ownerId\" : \"77d060ed-e686-4102-8a69-937a7e385efb\" } ], \"bio\" : \"bio\", \"ownerId\" : \"ed29628e-caf1-419f-9985-f8ecc6394b1e\", \"federalIdentification\" : \"111-22-3333\", \"enabled\" : true, \"accountEnabled\" : true, \"organizationId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"password\" : \"HardToGuess1980\", \"keyHash\" : \"keyHash\", \"lastModifiedById\" : \"b3bcecd5-3344-46c0-90c5-f1bfabee65b6\", \"fingerprint\" : \"DK$DFSJaraDD\", \"id\" : \"c62b9065-3bc5-445c-88ee-efeee05f207c\", \"email\" : \"wiley.coyote@acme-corp.com\", \"accountNonLocked\" : true, \"social\" : \"https://twitter.com/ValkyrAI\", \"avatarUrl\" : \"https://img.com/mypic.png\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"authorityList\" : [ { \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedById\" : \"65f9c26b-a776-453f-9d13-e3f8abfdc615\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"2d209bfb-1703-42f6-a2e2-c44c3be2f163\", \"authority\" : \"authority\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"id\" : \"7741596e-c29d-41fd-94eb-08ac186bf3bc\", \"ownerId\" : \"0e05e4d9-5c2e-40ac-b92d-3166daf592c4\", \"username\" : \"username\" }, { \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedById\" : \"65f9c26b-a776-453f-9d13-e3f8abfdc615\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"2d209bfb-1703-42f6-a2e2-c44c3be2f163\", \"authority\" : \"authority\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"id\" : \"7741596e-c29d-41fd-94eb-08ac186bf3bc\", \"ownerId\" : \"0e05e4d9-5c2e-40ac-b92d-3166daf592c4\", \"username\" : \"username\" } ], \"stateIdentification\" : \"3333333333\", \"firstName\" : \"Peace\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"organization\" : { \"address\" : { \"country\" : \"USA\", \"hasWifi\" : true, \"city\" : \"San Francisco\", \"lastAccessedById\" : \"ef297a29-e742-4535-82c6-6ef6211bca12\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"addressType\" : \"home\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"ownerId\" : \"5297b19d-fd2a-4007-9aef-f0b7264cd539\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"ba749007-a05a-4505-a434-d92c7cf9712d\", \"name\" : \"Henry Johnson\", \"street1\" : \"123 Daydream Blvd.\", \"street2\" : \"Apt. 7\", \"state\" : \"CA\", \"id\" : \"3773d666-dea1-4d02-b430-11ca52e266a8\", \"postal_code\" : \"94210-0000\" }, \"lastAccessedById\" : \"bbf6c89f-0f93-435f-871a-d2985bd90dbb\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"ownerId\" : \"07c45e12-d2e8-49ed-9e26-192e868673bc\", \"homePage\" : \"https://www.acme-corp.com\", \"addressId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"phone\" : \"415-867-5309\", \"lastModifiedById\" : \"2f3719a1-091e-47ab-89f9-9359e01e6feb\", \"name\" : \"ACME Corp Inc.\", \"id\" : \"96040b16-458f-46f6-8a90-6b163b2d6e12\" }, \"acceptedTos\" : false, \"credentialNonExpired\" : true, \"middleName\" : \"Love\", \"accountNonExpired\" : false, \"username\" : \"Sparky\" }, \"contentUrl\" : \"The url to the location of the full content\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"authorName\" : \"Jimjam McYoyo\", \"lastModifiedById\" : \"12d1e1b5-56db-42ea-9c02-e21facea7544\", \"subtitle\" : \"Many detailed things about all the things that hapened.\", \"contentMedia\" : [ { \"mediaUrl\" : \"http://example.com/aeiou\", \"lastAccessedById\" : \"e37f321d-d34f-4516-907b-f4626e955645\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"contentUse\" : \"none\", \"ownerId\" : \"209291e8-4da1-459c-b369-03cd93b15707\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"contentDataId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"lastModifiedById\" : \"85b9ccff-ee11-4973-bbef-0082a6886e2e\", \"id\" : \"db3b4973-11f0-4789-a296-c612f0c5e4a0\", \"applicationId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"contentType\" : \"image\" }, { \"mediaUrl\" : \"http://example.com/aeiou\", \"lastAccessedById\" : \"e37f321d-d34f-4516-907b-f4626e955645\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"contentUse\" : \"none\", \"ownerId\" : \"209291e8-4da1-459c-b369-03cd93b15707\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"contentDataId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"lastModifiedById\" : \"85b9ccff-ee11-4973-bbef-0082a6886e2e\", \"id\" : \"db3b4973-11f0-4789-a296-c612f0c5e4a0\", \"applicationId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"contentType\" : \"image\" } ], \"id\" : \"dc734ea0-5fa6-4147-b867-fba9849ce127\", \"thumbnailImage\" : \"https://valkyrlabs.com/assets/VALKYR_LABS_INC_LOGO-BKV9JIdt.png\", \"category\" : \"CodeGen\", \"contentType\" : \"CodeGen\", \"status\" : \"editing\" }, { \"largeImage\" : \"https://valkyrlabs.com/assets/VALKYR_LABS_INC_LOGO-BKV9JIdt.png\", \"contentData\" : \"The full content\", \"releaseDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedById\" : \"9dda17f7-3dad-4e27-af12-c2fc49cf31e1\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"title\" : \"Amazing Things Happened\", \"ownerId\" : \"bbf5fafc-2e00-4167-ad99-3abce968f129\", \"principal\" : { \"residenceCountry\" : \"USA\", \"residenceState\" : \"CA\", \"lastName\" : \"Harmony\", \"addresses\" : [ { \"country\" : \"USA\", \"hasWifi\" : true, \"city\" : \"San Francisco\", \"lastAccessedById\" : \"ef297a29-e742-4535-82c6-6ef6211bca12\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"addressType\" : \"home\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"ownerId\" : \"5297b19d-fd2a-4007-9aef-f0b7264cd539\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"ba749007-a05a-4505-a434-d92c7cf9712d\", \"name\" : \"Henry Johnson\", \"street1\" : \"123 Daydream Blvd.\", \"street2\" : \"Apt. 7\", \"state\" : \"CA\", \"id\" : \"3773d666-dea1-4d02-b430-11ca52e266a8\", \"postal_code\" : \"94210-0000\" }, { \"country\" : \"USA\", \"hasWifi\" : true, \"city\" : \"San Francisco\", \"lastAccessedById\" : \"ef297a29-e742-4535-82c6-6ef6211bca12\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"addressType\" : \"home\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"ownerId\" : \"5297b19d-fd2a-4007-9aef-f0b7264cd539\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"ba749007-a05a-4505-a434-d92c7cf9712d\", \"name\" : \"Henry Johnson\", \"street1\" : \"123 Daydream Blvd.\", \"street2\" : \"Apt. 7\", \"state\" : \"CA\", \"id\" : \"3773d666-dea1-4d02-b430-11ca52e266a8\", \"postal_code\" : \"94210-0000\" } ], \"notes\" : \"Notes about this account\", \"lastAccessedById\" : \"1417708a-45ad-43cd-a294-521766640255\", \"acceptedCookies\" : false, \"roles\" : [ { \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedById\" : \"e9b571b9-7603-4eba-822e-aa0005aff37a\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"cd99207c-073f-46f6-94f1-a9419d67befa\", \"roleName\" : \"ANONYMOUS\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"id\" : \"5b7c95bb-95c1-4cf9-86ca-c7d5f1d0a3b8\", \"ownerId\" : \"77d060ed-e686-4102-8a69-937a7e385efb\" }, { \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedById\" : \"e9b571b9-7603-4eba-822e-aa0005aff37a\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"cd99207c-073f-46f6-94f1-a9419d67befa\", \"roleName\" : \"ANONYMOUS\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"id\" : \"5b7c95bb-95c1-4cf9-86ca-c7d5f1d0a3b8\", \"ownerId\" : \"77d060ed-e686-4102-8a69-937a7e385efb\" } ], \"bio\" : \"bio\", \"ownerId\" : \"ed29628e-caf1-419f-9985-f8ecc6394b1e\", \"federalIdentification\" : \"111-22-3333\", \"enabled\" : true, \"accountEnabled\" : true, \"organizationId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"password\" : \"HardToGuess1980\", \"keyHash\" : \"keyHash\", \"lastModifiedById\" : \"b3bcecd5-3344-46c0-90c5-f1bfabee65b6\", \"fingerprint\" : \"DK$DFSJaraDD\", \"id\" : \"c62b9065-3bc5-445c-88ee-efeee05f207c\", \"email\" : \"wiley.coyote@acme-corp.com\", \"accountNonLocked\" : true, \"social\" : \"https://twitter.com/ValkyrAI\", \"avatarUrl\" : \"https://img.com/mypic.png\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"authorityList\" : [ { \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedById\" : \"65f9c26b-a776-453f-9d13-e3f8abfdc615\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"2d209bfb-1703-42f6-a2e2-c44c3be2f163\", \"authority\" : \"authority\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"id\" : \"7741596e-c29d-41fd-94eb-08ac186bf3bc\", \"ownerId\" : \"0e05e4d9-5c2e-40ac-b92d-3166daf592c4\", \"username\" : \"username\" }, { \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedById\" : \"65f9c26b-a776-453f-9d13-e3f8abfdc615\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"2d209bfb-1703-42f6-a2e2-c44c3be2f163\", \"authority\" : \"authority\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"id\" : \"7741596e-c29d-41fd-94eb-08ac186bf3bc\", \"ownerId\" : \"0e05e4d9-5c2e-40ac-b92d-3166daf592c4\", \"username\" : \"username\" } ], \"stateIdentification\" : \"3333333333\", \"firstName\" : \"Peace\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"organization\" : { \"address\" : { \"country\" : \"USA\", \"hasWifi\" : true, \"city\" : \"San Francisco\", \"lastAccessedById\" : \"ef297a29-e742-4535-82c6-6ef6211bca12\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"addressType\" : \"home\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"principalId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"ownerId\" : \"5297b19d-fd2a-4007-9aef-f0b7264cd539\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastModifiedById\" : \"ba749007-a05a-4505-a434-d92c7cf9712d\", \"name\" : \"Henry Johnson\", \"street1\" : \"123 Daydream Blvd.\", \"street2\" : \"Apt. 7\", \"state\" : \"CA\", \"id\" : \"3773d666-dea1-4d02-b430-11ca52e266a8\", \"postal_code\" : \"94210-0000\" }, \"lastAccessedById\" : \"bbf6c89f-0f93-435f-871a-d2985bd90dbb\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"ownerId\" : \"07c45e12-d2e8-49ed-9e26-192e868673bc\", \"homePage\" : \"https://www.acme-corp.com\", \"addressId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"phone\" : \"415-867-5309\", \"lastModifiedById\" : \"2f3719a1-091e-47ab-89f9-9359e01e6feb\", \"name\" : \"ACME Corp Inc.\", \"id\" : \"96040b16-458f-46f6-8a90-6b163b2d6e12\" }, \"acceptedTos\" : false, \"credentialNonExpired\" : true, \"middleName\" : \"Love\", \"accountNonExpired\" : false, \"username\" : \"Sparky\" }, \"contentUrl\" : \"The url to the location of the full content\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"authorName\" : \"Jimjam McYoyo\", \"lastModifiedById\" : \"12d1e1b5-56db-42ea-9c02-e21facea7544\", \"subtitle\" : \"Many detailed things about all the things that hapened.\", \"contentMedia\" : [ { \"mediaUrl\" : \"http://example.com/aeiou\", \"lastAccessedById\" : \"e37f321d-d34f-4516-907b-f4626e955645\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"contentUse\" : \"none\", \"ownerId\" : \"209291e8-4da1-459c-b369-03cd93b15707\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"contentDataId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"lastModifiedById\" : \"85b9ccff-ee11-4973-bbef-0082a6886e2e\", \"id\" : \"db3b4973-11f0-4789-a296-c612f0c5e4a0\", \"applicationId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"contentType\" : \"image\" }, { \"mediaUrl\" : \"http://example.com/aeiou\", \"lastAccessedById\" : \"e37f321d-d34f-4516-907b-f4626e955645\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"lastAccessedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"contentUse\" : \"none\", \"ownerId\" : \"209291e8-4da1-459c-b369-03cd93b15707\", \"keyHash\" : \"keyHash\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"contentDataId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"lastModifiedById\" : \"85b9ccff-ee11-4973-bbef-0082a6886e2e\", \"id\" : \"db3b4973-11f0-4789-a296-c612f0c5e4a0\", \"applicationId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\", \"contentType\" : \"image\" } ], \"id\" : \"dc734ea0-5fa6-4147-b867-fba9849ce127\", \"thumbnailImage\" : \"https://valkyrlabs.com/assets/VALKYR_LABS_INC_LOGO-BKV9JIdt.png\", \"category\" : \"CodeGen\", \"contentType\" : \"CodeGen\", \"status\" : \"editing\" } ]";
                                ApiUtil.setExampleResponse(request, "application/json", exampleString);
                                break;
                            }
                            }
                ...
                /// ThorAPI method impl
                if(contentDataService.findAll() == null){
                    return new ResponseEntity<>(HttpStatus.NOT_FOUND);
                }
                return new ResponseEntity<>((List<ContentData>)contentDataService.findAll(), HttpStatus.OK);
                /// END ThorAPI method impl
                }, Runnable::run);
        ...
        * @return ContentData created successfully. (status code 201)
            ...
            *         or ContentData not found. (status code 404)
            *         or Internal server error. (status code 500)
        * @see ContentDataApi#postContentData
        */
    ...
    public CompletableFuture<ResponseEntity<ContentData>> postContentData(ContentData contentData) {
        // ThorAPI Method Template
            ...
            getRequest().ifPresent(request -> {
                ...
                /// ThorAPI method impl
                            // ThorAPI CREATE
                            logger.trace("CREATING RECORD: contentData");
                            ContentData ox = contentDataService.saveOrUpdate(contentData);
                            return new ResponseEntity<ContentData>(contentDataService.findById(ox.getId()).get(), HttpStatus.CREATED);
                /// END ThorAPI method impl
                }, Runnable::run);
        ...
        * @return ContentData updated successfully. (status code 200)
            ...
            *         or ContentData not found. (status code 404)
            *         or Internal server error. (status code 500)
        * @see ContentDataApi#updateContentData
        */
    ...
    public CompletableFuture<ResponseEntity<ContentData>> updateContentData(UUID id,
    ContentData contentData) {
        // ThorAPI Method Template
            ...
            getRequest().ifPresent(request -> {
                ...
                /// ThorAPI method impl
                            // ThorAPI UPDATE
                            // logger.trace("UPDATING RECORD:" + contentData);
                            if(contentDataService.findById(id).isEmpty()){
                                return new ResponseEntity<>( HttpStatus.NOT_FOUND);
                            }
                            contentData.setId(id); // guard against a patch with no ID (upserts new objects)
                            ContentData ox = contentDataService.saveOrUpdate(contentData);
                            return new ResponseEntity<ContentData>(contentDataService.findById(ox.getId()).get(), HttpStatus.OK);
                /// END ThorAPI method impl
                }, Runnable::run);
