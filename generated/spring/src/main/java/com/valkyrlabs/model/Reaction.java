...
@Schema(name = "Reaction", description = "Reaction allows for tagging any content in the system with an emoji")
...
public class Reaction  implements DataObject   {
  ...
  public enum ReactionEnum {
    ...
    @AuditedField
        ...
        public Reaction targetObject(UUID targetObject) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "targetObject", description = "UUID of the system object", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Reaction reaction(ReactionEnum reaction) {
        ...
        return this;
            ...
            */
                ...
                @Schema(name = "reaction", example = "neutral", description = "the reaction to the item", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "id", example = "748824b7-8b30-40f8-b099-46fbd1fbc739", description = "Unique identifier for object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
                @JsonProperty("id")
            public UUID getId() {
            return id;
            }
        ...
        public Reaction ownerId(UUID ownerId) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "ownerId", example = "90ed9ad0-9364-42a5-8109-601066daf3ea", description = "UUID of owner of the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Reaction createdDate(OffsetDateTime createdDate) {
        ...
        public Reaction keyHash(String keyHash) {
        ...
        public Reaction lastAccessedById(UUID lastAccessedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastAccessedById", example = "738630bd-a6e2-4bf1-921b-70ce51df13bf", description = "Last user to access object", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Reaction lastAccessedDate(OffsetDateTime lastAccessedDate) {
        ...
        public Reaction lastModifiedById(UUID lastModifiedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastModifiedById", example = "81f990ca-8e7a-467d-aad0-8ce6c5533025", description = "Unique identifier for user who last modifed the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Reaction lastModifiedDate(OffsetDateTime lastModifiedDate) {
        ...
        return false;
            ...
            return Objects.equals(this.targetObject, reaction.targetObject) &&
            Objects.equals(this.reaction, reaction.reaction) &&
            Objects.equals(this.id, reaction.id) &&
            Objects.equals(this.ownerId, reaction.ownerId) &&
            Objects.equals(this.createdDate, reaction.createdDate) &&
            Objects.equals(this.keyHash, reaction.keyHash) &&
            Objects.equals(this.lastAccessedById, reaction.lastAccessedById) &&
            Objects.equals(this.lastAccessedDate, reaction.lastAccessedDate) &&
            Objects.equals(this.lastModifiedById, reaction.lastModifiedById) &&
            Objects.equals(this.lastModifiedDate, reaction.lastModifiedDate);
        }

            @Override
            public int hashCode() {
            return Objects.hash(targetObject, reaction, id, ownerId, createdDate, keyHash, lastAccessedById, lastAccessedDate, lastModifiedById, lastModifiedDate);
            }
            @Override
            public String toString() {
