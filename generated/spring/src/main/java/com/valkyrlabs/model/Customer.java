...
@Schema(name = "Customer", description = "Represents a customer entity for CRM.")
    ...
    @AuditedField
        ...
        */
        ...
        return this;
            ...
            */
                @NotNull @Valid 
                @Schema(name = "customerId", description = "Associated customer Principal ID.", requiredMode = Schema.RequiredMode.REQUIRED)
        ...
        public Customer customer(Principal customer) {
        ...
        return this;
            ...
            */
            ...
            public Principal getCustomer() {
            return customer;
            }
            public void setCustomer(Principal customer) {
            this.customer = customer;
            }
        ...
        return this;
            ...
            */
                ...
                @Schema(name = "status", description = "Status of the customer.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
                @JsonProperty("status")
        ...
        return this;
            ...
            */
                ...
                @Schema(name = "role", description = "Role of the contact person within the customer account (e.g., CEO, Procurement, Technical Lead).", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
                @JsonProperty("role")
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "id", example = "c0baba1c-adeb-46d9-a3bf-9abd77b96ee2", description = "Unique identifier for object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
                @JsonProperty("id")
            public UUID getId() {
            return id;
            }
        ...
        public Customer ownerId(UUID ownerId) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "ownerId", example = "aabd4bac-f0b3-428d-a94c-2bcb1ccab417", description = "UUID of owner of the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Customer createdDate(OffsetDateTime createdDate) {
        ...
        public Customer keyHash(String keyHash) {
        ...
        public Customer lastAccessedById(UUID lastAccessedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastAccessedById", example = "09309af7-d8d4-424d-91d4-98fb2fe1331c", description = "Last user to access object", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Customer lastAccessedDate(OffsetDateTime lastAccessedDate) {
        ...
        public Customer lastModifiedById(UUID lastModifiedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastModifiedById", example = "fb86dcdc-dd42-4699-99e0-817962f03fe7", description = "Unique identifier for user who last modifed the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Customer lastModifiedDate(OffsetDateTime lastModifiedDate) {
        ...
        return false;
            ...
            Objects.equals(this.keyHash, customer.keyHash) &&
            Objects.equals(this.lastAccessedById, customer.lastAccessedById) &&
            Objects.equals(this.lastAccessedDate, customer.lastAccessedDate) &&
            Objects.equals(this.lastModifiedById, customer.lastModifiedById) &&
            Objects.equals(this.lastModifiedDate, customer.lastModifiedDate);
        }

            @Override
            public int hashCode() {
            return Objects.hash(customerId, customer, status, role, id, ownerId, createdDate, keyHash, lastAccessedById, lastAccessedDate, lastModifiedById, lastModifiedDate);
            }
            @Override
            public String toString() {
