...
@Schema(name = "GameWeaponIDX", description = "IDX object that links weapons to games")
...
public class GameWeaponIDX  implements DataObject   {
    ...
    @AuditedField
        ...
        public GameWeaponIDX gameId(UUID gameId) {
            this.gameId = gameId;
        return this;
        }
            /**
        ...
        public GameWeaponIDX weaponId(UUID weaponId) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "weaponId", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public GameWeaponIDX id(UUID id) {
            this.id = id;
        return this;
        }
            /**
            ...
            */
                @Valid 
                @Schema(name = "id", example = "4b37eb03-82c6-4146-8e5b-b715c165f580", description = "Unique identifier for object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
                @JsonProperty("id")
            public UUID getId() {
            return id;
            }
        ...
        public GameWeaponIDX ownerId(UUID ownerId) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "ownerId", example = "80601c34-1c3e-4710-8527-a27c0737921f", description = "UUID of owner of the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public GameWeaponIDX createdDate(OffsetDateTime createdDate) {
        ...
        public GameWeaponIDX keyHash(String keyHash) {
        ...
        public GameWeaponIDX lastAccessedById(UUID lastAccessedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastAccessedById", example = "619a6ba7-3f15-49db-a680-86f9f804ba73", description = "Last user to access object", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public GameWeaponIDX lastAccessedDate(OffsetDateTime lastAccessedDate) {
        ...
        public GameWeaponIDX lastModifiedById(UUID lastModifiedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastModifiedById", example = "44b24cd5-32de-49d0-a1e0-943507f98605", description = "Unique identifier for user who last modifed the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public GameWeaponIDX lastModifiedDate(OffsetDateTime lastModifiedDate) {
        ...
        return false;
            ...
            GameWeaponIDX gameWeaponIDX = (GameWeaponIDX) o;
            return Objects.equals(this.gameId, gameWeaponIDX.gameId) &&
            Objects.equals(this.weaponId, gameWeaponIDX.weaponId) &&
            Objects.equals(this.id, gameWeaponIDX.id) &&
            Objects.equals(this.ownerId, gameWeaponIDX.ownerId) &&
            Objects.equals(this.createdDate, gameWeaponIDX.createdDate) &&
            Objects.equals(this.keyHash, gameWeaponIDX.keyHash) &&
            Objects.equals(this.lastAccessedById, gameWeaponIDX.lastAccessedById) &&
            Objects.equals(this.lastAccessedDate, gameWeaponIDX.lastAccessedDate) &&
            Objects.equals(this.lastModifiedById, gameWeaponIDX.lastModifiedById) &&
            Objects.equals(this.lastModifiedDate, gameWeaponIDX.lastModifiedDate);
        }

            @Override
            public int hashCode() {
            return Objects.hash(gameId, weaponId, id, ownerId, createdDate, keyHash, lastAccessedById, lastAccessedDate, lastModifiedById, lastModifiedDate);
            }
            @Override
            public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class GameWeaponIDX {\n");
