...
public class Role  implements DataObject   {
  ...
  public enum RoleNameEnum {
    ...
    @AuditedField
        ...
        public Role principalId(UUID principalId) {
        ...
        public Role roleName(RoleNameEnum roleName) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "id", example = "5b7c95bb-95c1-4cf9-86ca-c7d5f1d0a3b8", description = "Unique identifier for object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
                @JsonProperty("id")
            public UUID getId() {
            return id;
            }
        ...
        public Role ownerId(UUID ownerId) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "ownerId", example = "77d060ed-e686-4102-8a69-937a7e385efb", description = "UUID of owner of the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Role keyHash(String keyHash) {
        ...
        public Role lastAccessedById(UUID lastAccessedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastAccessedById", example = "e9b571b9-7603-4eba-822e-aa0005aff37a", description = "Last user to access object", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Role lastAccessedDate(OffsetDateTime lastAccessedDate) {
        ...
        public Role lastModifiedById(UUID lastModifiedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastModifiedById", example = "cd99207c-073f-46f6-94f1-a9419d67befa", description = "Unique identifier for user who last modifed the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        return false;
            ...
            Objects.equals(this.keyHash, role.keyHash) &&
            Objects.equals(this.lastAccessedById, role.lastAccessedById) &&
            Objects.equals(this.lastAccessedDate, role.lastAccessedDate) &&
            Objects.equals(this.lastModifiedById, role.lastModifiedById) &&
            Objects.equals(this.lastModifiedDate, role.lastModifiedDate);
        }

            @Override
            public int hashCode() {
            return Objects.hash(principalId, roleName, id, ownerId, createdDate, keyHash, lastAccessedById, lastAccessedDate, lastModifiedById, lastModifiedDate);
            }
            @Override
            public String toString() {
