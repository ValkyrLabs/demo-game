...
@Schema(name = "Logout", description = "Logout functionality")
...
public class Logout  implements DataObject   {
    ...
    @AuditedField
        ...
        public Logout description(String description) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "id", example = "8ec508fe-99a6-4a98-b47e-e28d057b6284", description = "Unique identifier for object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
                @JsonProperty("id")
            public UUID getId() {
            return id;
            }
        ...
        public Logout ownerId(UUID ownerId) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "ownerId", example = "29cfd419-c81a-47ae-8600-79ac5d8cc6c7", description = "UUID of owner of the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Logout createdDate(OffsetDateTime createdDate) {
        ...
        public Logout keyHash(String keyHash) {
        ...
        public Logout lastAccessedById(UUID lastAccessedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastAccessedById", example = "93850cc7-673e-48ea-a594-385bde8e9fca", description = "Last user to access object", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Logout lastAccessedDate(OffsetDateTime lastAccessedDate) {
        ...
        public Logout lastModifiedById(UUID lastModifiedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastModifiedById", example = "60418982-a1ea-4832-8848-d37adf120363", description = "Unique identifier for user who last modifed the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Logout lastModifiedDate(OffsetDateTime lastModifiedDate) {
        ...
        return false;
            ...
            return Objects.equals(this.description, logout.description) &&
            Objects.equals(this.id, logout.id) &&
            Objects.equals(this.ownerId, logout.ownerId) &&
            Objects.equals(this.createdDate, logout.createdDate) &&
            Objects.equals(this.keyHash, logout.keyHash) &&
            Objects.equals(this.lastAccessedById, logout.lastAccessedById) &&
            Objects.equals(this.lastAccessedDate, logout.lastAccessedDate) &&
            Objects.equals(this.lastModifiedById, logout.lastModifiedById) &&
            Objects.equals(this.lastModifiedDate, logout.lastModifiedDate);
        }

            @Override
            public int hashCode() {
            return Objects.hash(description, id, ownerId, createdDate, keyHash, lastAccessedById, lastAccessedDate, lastModifiedById, lastModifiedDate);
            }
            @Override
