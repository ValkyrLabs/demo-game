...
@Schema(name = "Game", description = "Percival the Dragon Slayer")
...
public class Game  implements DataObject   {
    ...
    @AuditedField
        ...
        private List<@Valid GameWeaponIDX> weapons = new ArrayList<>();
    ...
    @AuditedField
        ...
        return this;
            ...
            */
                ...
                @Schema(name = "name", description = "the name of the game", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
                @JsonProperty("name")
        ...
        public Game weapons(List<@Valid GameWeaponIDX> weapons) {
            this.weapons = weapons;
        return this;
        }
            public Game addWeaponsItem(GameWeaponIDX weaponsItem) {
            ...
            */
            ...
            public List<@Valid GameWeaponIDX> getWeapons() {
            return weapons;
            }
            public void setWeapons(List<@Valid GameWeaponIDX> weapons) {
            this.weapons = weapons;
            }
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "id", example = "2fc54c12-6913-478e-a087-e2222bf27ea5", description = "Unique identifier for object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
                @JsonProperty("id")
            public UUID getId() {
            return id;
            }
        ...
        public Game ownerId(UUID ownerId) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "ownerId", example = "7d6f7412-2a3c-44f8-98be-b5b022b4829e", description = "UUID of owner of the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Game createdDate(OffsetDateTime createdDate) {
        ...
        public Game keyHash(String keyHash) {
        ...
        public Game lastAccessedById(UUID lastAccessedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastAccessedById", example = "537dbb10-653a-4599-9049-0bc65a86babb", description = "Last user to access object", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Game lastAccessedDate(OffsetDateTime lastAccessedDate) {
        ...
        public Game lastModifiedById(UUID lastModifiedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastModifiedById", example = "2e2698cb-2812-4af2-9835-0307fb620b25", description = "Unique identifier for user who last modifed the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Game lastModifiedDate(OffsetDateTime lastModifiedDate) {
        ...
        return false;
            ...
            Objects.equals(this.weapons, game.weapons) &&
            Objects.equals(this.id, game.id) &&
            Objects.equals(this.ownerId, game.ownerId) &&
            Objects.equals(this.createdDate, game.createdDate) &&
            Objects.equals(this.keyHash, game.keyHash) &&
            Objects.equals(this.lastAccessedById, game.lastAccessedById) &&
            Objects.equals(this.lastAccessedDate, game.lastAccessedDate) &&
            Objects.equals(this.lastModifiedById, game.lastModifiedById) &&
            Objects.equals(this.lastModifiedDate, game.lastModifiedDate);
        }

            @Override
            public int hashCode() {
            return Objects.hash(name, weapons, id, ownerId, createdDate, keyHash, lastAccessedById, lastAccessedDate, lastModifiedById, lastModifiedDate);
            }
            @Override
