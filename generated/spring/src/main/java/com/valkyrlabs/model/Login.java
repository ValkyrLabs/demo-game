...
public class Login  implements DataObject   {
    ...
    @AuditedField
        ...
        public Login description(String description) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "id", example = "3cb40daa-6d45-4c2b-9f50-744a51569c8c", description = "Unique identifier for object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
                @JsonProperty("id")
            public UUID getId() {
            return id;
            }
        ...
        public Login ownerId(UUID ownerId) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "ownerId", example = "f1d30892-3d4d-47d7-b169-556ee41de2a9", description = "UUID of owner of the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Login createdDate(OffsetDateTime createdDate) {
        ...
        public Login keyHash(String keyHash) {
        ...
        public Login lastAccessedById(UUID lastAccessedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastAccessedById", example = "85d6f022-8a45-4cda-bcf8-df73fd27015d", description = "Last user to access object", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Login lastAccessedDate(OffsetDateTime lastAccessedDate) {
        ...
        public Login lastModifiedById(UUID lastModifiedById) {
        ...
        return this;
            ...
            */
                @Valid 
                @Schema(name = "lastModifiedById", example = "310674e0-b7b1-4e08-aaf6-c535400d281f", description = "Unique identifier for user who last modifed the object in the system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        public Login lastModifiedDate(OffsetDateTime lastModifiedDate) {
        ...
        return false;
            ...
            Objects.equals(this.description, login.description) &&
            Objects.equals(this.id, login.id) &&
            Objects.equals(this.ownerId, login.ownerId) &&
            Objects.equals(this.createdDate, login.createdDate) &&
            Objects.equals(this.keyHash, login.keyHash) &&
            Objects.equals(this.lastAccessedById, login.lastAccessedById) &&
            Objects.equals(this.lastAccessedDate, login.lastAccessedDate) &&
            ...
            @Override
            public int hashCode() {
            return Objects.hash(username, password, description, id, ownerId, createdDate, keyHash, lastAccessedById, lastAccessedDate, lastModifiedById, lastModifiedDate);
            }
            @Override
