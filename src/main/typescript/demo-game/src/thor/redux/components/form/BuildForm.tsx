...
const BuildForm: React.FC = () => {
  ...
  const initialValues: Build = {
    ...
    id : 'df88cd59-258c-4ed3-b8e6-e35414f0a387',
    ...
    ownerId : '449c6dd6-9d87-4a1d-8d7d-724dab28587e',
    ...
    lastAccessedById : '26f4a32a-66a3-4f7f-b2b4-9f6c6266ead8',
    ...
    lastModifiedById : '4044cc46-020c-4374-94a7-0a533fea6391',
